...
public class MainViewModelForSearch extends ViewModel {
    private static final String API_KEY = "652ae94b7a67745bd01006a794b01893";


    void setFilm(String language, final String get_film, String searchFor){
        AsyncHttpClient client = new AsyncHttpClient();
        final ArrayList<FilmItems> listItems = new ArrayList<>();

        String url = "https://api.themoviedb.org/3/search/" + get_film + "?api_key=" + API_KEY + "&language=" + language + "&query=" + searchFor;
