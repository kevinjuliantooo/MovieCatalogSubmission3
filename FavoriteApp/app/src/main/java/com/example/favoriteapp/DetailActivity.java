...
import static com.example.favoriteapp.DatabaseFavoriteContract.NoteColumns.FAVORITE_ID;
...
//            db.insert(TABLE_NAME, null, values);
            ...
            getContentResolver().insert(DatabaseFavoriteContract.NoteColumns.CONTENT_URI, values);
...
//            favoriteHelper.deleteByItem(selection, selectionArgs);
            getContentResolver().delete(DatabaseFavoriteContract.NoteColumns.CONTENT_URI, selection, selectionArgs);
